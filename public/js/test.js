!(function (t, i) {
  ...
  class r extends e {
    constructor(t) {
      ...
      super(
        Object.assign(Object.assign({}, t), {
          audioBitsPerSecond:
            null !== (i = t.audioBitsPerSecond) && void 0 !== i ? i : 128e3,
          scrollingWaveform:
            null !== (e = t.scrollingWaveform) && void 0 !== e && e,
          scrollingWaveformWindow:
            null !== (o = t.scrollingWaveformWindow) && void 0 !== o ? o : 5,
          continuousWaveform:
            null !== (r = t.continuousWaveform) && void 0 !== r && r,
          renderRecordedAudio:
            null === (n = t.renderRecordedAudio) || void 0 === n || n,
          mediaRecorderTimeslice:
            null !== (a = t.mediaRecorderTimeslice) && void 0 !== a
              ? a
              : void 0,
        })
      ),
    ...
    renderMicStream(t) {
      ...
      let a = 0;
      this.wavesurfer &&
        ((null !== (i = this.originalOptions) && void 0 !== i) ||
          (this.originalOptions = Object.assign({}, this.wavesurfer.options)),
        (this.wavesurfer.options.interact = !1),
        this.options.scrollingWaveform &&
      ...
      const d = setInterval(() => {
        ...
        if (!this.isWaveformPaused) {
          if ((o.getFloatTimeDomainData(n), this.options.scrollingWaveform)) {
            const t = Math.floor(
                (this.options.scrollingWaveformWindow || 0) * e.sampleRate
              ),
            ...
            if (!this.dataWindow) {
              const e = this.options.continuousWaveformDuration
                ? Math.round(100 * this.options.continuousWaveformDuration)
                : (null !==
                    (i =
          ...
          if (this.wavesurfer) {
            const t =
              (null !==
                (d =
                  null === (s = this.dataWindow) || void 0 === s
                    ? void 0
                    : s.length) && void 0 !== d
                ? d
                : 0) / 100;
            this.wavesurfer
              .load(
                ...
                [this.dataWindow],
                this.options.scrollingWaveform
                  ? this.options.scrollingWaveformWindow
                  : t
              )
              .then(() => {
                this.wavesurfer &&
                  this.options.continuousWaveform &&
                  (this.wavesurfer.setTime(this.getDuration() / 1e3),
                  this.wavesurfer.options.minPxPerSec ||
                    this.wavesurfer.setOptions({
                      minPxPerSec:
                        this.wavesurfer.getWidth() /
      ...
      return t(this, void 0, void 0, function* () {
        ...
        try {
          t = yield navigator.mediaDevices.getUserMedia({
            audio: !(null == i ? void 0 : i.deviceId) || {
              deviceId: i.deviceId,
            },
          });
        } catch (t) {
        ...
        return (
          this.subscriptions.push(this.once("destroy", e)),
          this.subscriptions.push(this.once("record-end", s)),
          (this.stream = t),
          t
        );
      });
        ...
        const e =
          ...
          new MediaRecorder(t, {
            mimeType:
              ...
              o.find((t) => MediaRecorder.isTypeSupported(t)),
            audioBitsPerSecond: this.options.audioBitsPerSecond,
          });
        (this.mediaRecorder = e), this.stopRecording();
        const s = [];
        e.ondataavailable = (t) => {
          t.data.size > 0 && s.push(t.data),
            this.emit("record-data-available", t.data);
        };
        const r = (t) => {
          var i;
          const o = new Blob(s, { type: e.mimeType });
          this.emit(t, o),
            this.options.renderRecordedAudio &&
              (this.applyOriginalOptionsIfNeeded(),
              null === (i = this.wavesurfer) ||
                void 0 === i ||
                i.load(URL.createObjectURL(o)));
        };
        (e.onpause = () => r("record-pause")),
          (e.onstop = () => r("record-end")),
          e.start(this.options.mediaRecorderTimeslice),
    ...
    isRecording() {
      ...
      return (
        "recording" ===
        (null === (t = this.mediaRecorder) || void 0 === t ? void 0 : t.state)
      );
    }
    isPaused() {
      var t;
    ...
    stopRecording() {
      var t;
      this.isActive() &&
        (null === (t = this.mediaRecorder) || void 0 === t || t.stop(),
        this.timer.stop());
    }
    pauseRecording() {
      var t, i;
      this.isRecording() &&
        ...
        null === (t = this.mediaRecorder) || void 0 === t || t.requestData(),
        null === (i = this.mediaRecorder) || void 0 === i || i.pause(),
        this.timer.stop(),
    ...
    resumeRecording() {
      ...
      this.isPaused() &&
        ((this.isWaveformPaused = !1),
        null === (t = this.mediaRecorder) || void 0 === t || t.resume(),
        this.timer.start(),
        (this.lastStartTime = performance.now()),
    ...
    static getAvailableAudioDevices() {
      return t(this, void 0, void 0, function* () {
        return navigator.mediaDevices
          .enumerateDevices()
          .then((t) => t.filter((t) => "audioinput" === t.kind));
      });
    }
    destroy() {
      this.applyOriginalOptionsIfNeeded(),
